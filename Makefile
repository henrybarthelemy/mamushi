...
ifeq ($(UNAME), Linux)
  NASM_FORMAT=elf64
  CLANG_FLAGS=-mstackrealign -m64 -g -fstack-protector-all -Wstack-protector -fno-omit-frame-pointer -z noexecstack -no-pie
...
output/%.run: output/%.o main.c gc.c snake.c
	clang $(CLANG_FLAGS) -o $@ gc.c main.c snake.c $<
...
output/do_pass/%.run: output/do_pass/%.o main.c gc.c snake.c
	clang $(CLANG_FLAGS) -o $@ gc.c main.c snake.c $<
...
output/dont_pass/%.run: output/dont_pass/%.o main.c gc.c snake.c
	clang -g $(CLANG_FLAGS) -o $@ gc.c main.c snake.c $<
...
output/do_err/%.run: output/do_err/%.o main.c gc.c snake.c
	clang $(CLANG_FLAGS) -o $@ gc.c main.c snake.c $<
...
output/dont_err/%.run: output/dont_err/%.o main.c gc.c snake.c
	clang -g $(CLANG_FLAGS) -o $@ gc.c main.c snake.c $<
